/*
  ...
  - You are about to drop the column `whatapp_number` on the `users` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "users" DROP COLUMN "whatapp_number",
